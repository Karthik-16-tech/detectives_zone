...
export function WhatIsDetectiveZone() {
  ...
  return (
    <section ref={ref} id="what-is" className="shell mt-14 sm:mt-24 lg:mt-32 scroll-mt-[64px]">
      <div className="grid grid-cols-12 items-center gap-10">
        ...
        >
          ...
          <h2 className="mt-6 font-display text-[clamp(2rem,8vw,2.875rem)] leading-[0.95] font-bold uppercase">
            An archive of
            <br />
            unfinished truths
          </h2>
