...
function AboutPage() {
  ...
  return (
    <div className="about-noir noir-grain relative min-h-screen max-w-full overflow-x-clip bg-background">
      ...
      <main className="relative z-10 mx-auto max-w-[1500px] px-6 pt-28 pb-24">
        {/* ── HERO ─────────────────────────────────────────────── */}
        <section className="grid items-center gap-10 lg:grid-cols-[1.05fr_1fr]">
          <div>
            <p className="font-tech mb-6 text-[11px] tracking-[0.4em] text-primary">// ABOUT US</p>

            <div className="dz-headline relative">
              <h1 className="font-display text-[14vw] leading-[0.78] tracking-tight sm:text-[9.5rem]">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-16 left-2 w-40 -rotate-3 bg-paper p-4 text-center font-display text-xs leading-relaxed tracking-[0.15em] text-paper-foreground shadow-[0_20px_40px_-18px_rgb(0_0_0/0.9)]">
              TRUTH IS HIDDEN IN DETAILS
              <div className="tape absolute -top-3 left-1/2 h-6 w-16 -translate-x-1/2 -rotate-6" />
            </div>
          </div>
        </section>
        ...
        <Reveal className="mt-16">
          <div className="glass-card grid divide-y divide-border/60 sm:grid-cols-3 sm:divide-x sm:divide-y-0 [perspective:1400px]">
            {FEATURES.map(({ icon: Icon, title, sub }) => (
              <div key={title} className="lift-3d flex items-center gap-4 px-8 py-7">
                <Icon className="size-8 shrink-0 text-primary" strokeWidth={1.2} />
        ...
        <Reveal className="mt-24">
          <div className="dossier relative p-8 lg:p-12">
            <div className="tape absolute -left-6 -top-5 h-10 w-32 -rotate-12" />
            <div className="tape absolute -right-6 -bottom-5 h-10 w-32 -rotate-6" />
            <div className="grid gap-10 lg:grid-cols-[0.8fr_2fr]">
              <div>
                <p className="font-tech mb-4 text-[10px] tracking-[0.3em] text-primary/80">
                  DOSSIER DZ-00
                </p>
                ...
                <div className="relative mt-10 flex size-28 flex-col items-center justify-center rounded-full border-2 border-dashed border-primary/50 font-display text-[10px] leading-tight tracking-[0.2em] text-primary/80">
                  <Fingerprint
              ...
              <div className="grid gap-px bg-border/60 sm:grid-cols-2 xl:grid-cols-4 [perspective:1400px]">
                {PURPOSE.map(({ icon: Icon, title, text }) => (
                  ...
                  >
                    ...
                    <h3 className="mt-6 font-display text-sm leading-snug tracking-[0.14em] text-foreground">
                      {title}
                    </h3>
        ...
        <section className="mt-24">
          <Reveal>
            ...
            <div className="mt-3 h-px w-28 bg-primary" />
          </Reveal>

          <div className="mt-10 grid gap-6 lg:grid-cols-3 [perspective:1600px]">
            {BELIEFS.map(({ img, title, text }, i) => (
              <Reveal key={title} delay={i * 120}>
                <article className="glass-card lift-3d h-full overflow-hidden">
                  ...
                  />
                  <div className="p-6">
                    <h3 className="font-display text-base tracking-[0.14em] text-foreground">
                      {title}
                    </h3>
        ...
        {/* ── FINAL CTA DOSSIER ─────────────────────────────────── */}
        <Reveal className="mt-24">
          <div className="dossier relative grid items-center gap-10 p-8 lg:grid-cols-[0.7fr_1.4fr_1fr] lg:p-12">
            <div className="relative -rotate-2 bg-paper p-6 text-paper-foreground shadow-[0_30px_60px_-30px_rgb(0_0_0/0.95)]">
              <div className="tape absolute -top-4 left-8 h-8 w-24 -rotate-6" />
              <p className="font-display text-sm tracking-[0.2em] text-primary">YOUR ROLE</p>
              <p className="mt-4 font-hand text-xl leading-snug">
              ...
              <Fingerprint className="mt-4 size-10 opacity-40" strokeWidth={0.8} />
            </div>

            <div>
              <h2 className="font-display text-4xl leading-[1.05] tracking-[0.04em] sm:text-5xl">
              ...
              <p className="mt-6 inline-block border-b border-primary/60 pb-1 font-hand text-3xl text-primary">
                Are you ready?
              </p>
            </div>

            <div className="relative rotate-2 border border-border/60">
              <img
                src={ctaDesk}
              ...
              />
              <div className="tape absolute -top-4 right-8 h-8 w-24 rotate-6" />
            </div>
          </div>
        </Reveal>
      </main>
